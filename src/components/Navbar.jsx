...
const Navbar = ({theme, setTheme}) => {
    ...
    return (
        ...
        className='flex justify-between items-center py-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70 '>
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
            ...
            <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon} alt="" className='w-8 sm:hidden cursor-pointer' onClick={()=>{setSidebarOpen(true)}}/>
